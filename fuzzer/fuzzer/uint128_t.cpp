...
uint128_t::operator bool() const { return (bool)(UPPER | LOWER); }

uint128_t::operator char() const { return (char)LOWER; }
uint128_t::operator int() const { return (int)LOWER; }

uint128_t::operator uint8_t() const { return (uint8_t)LOWER; }

uint128_t::operator uint16_t() const { return (uint16_t)LOWER; }

uint128_t::operator uint32_t() const { return (uint32_t)LOWER; }

uint128_t::operator uint64_t() const { return (uint64_t)LOWER; }
...
uint128_t uint128_t::operator~() const { return uint128_t(~UPPER, ~LOWER); }
...
uint128_t uint128_t::operator<<(const uint128_t &rhs) const {
  ...
  if (((bool)rhs.UPPER) || (shift >= 128)) {
    ...
    return uint128_t((UPPER << shift) + (LOWER >> (64 - shift)), LOWER
                                                                     << shift);
...
bool uint128_t::operator!() const { return !(bool)(UPPER | LOWER); }
...
uint128_t uint128_t::operator*(const uint128_t &rhs) const {
  ...
  return uint128_t(first32 << 32, 0) + uint128_t(third32 >> 32, third32 << 32) +
         uint128_t(second32, 0) + uint128_t(fourth32);
}
...
std::pair<uint128_t, uint128_t> uint128_t::divmod(const uint128_t &lhs,
...
uint64_t uint128_t::upper() const { return UPPER; }

uint64_t uint128_t::lower() const { return LOWER; }
